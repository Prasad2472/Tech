...
public class FindBalancedIndexes {
	...
	private static Set<Integer> getIndexes() {
		...
		for (int i = 1; i < elements.length; i++) {
			...
			System.out.println("Current Element:" + elements[i] + ": lastElement:" + lastElement);
			// Reset
			rightElementsMultiplication = lastElement;
			// For multiplication
			...
			System.out
					.println("previousSum:" + leftElementsSum + ", nextMultiplication:" + rightElementsMultiplication);
